...
//   return (
//     <div className="min-h-screen flex items-center justify-center bg-[#FFF5EB] dark:bg-gray-900 transition-colors duration-300">
...
//           Already have an account? <a href="/login" className="text-[#FF4C29] font-medium">Login</a>
//         </p>
//       </div>
//     </div>
//   );
