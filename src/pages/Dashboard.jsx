  ...
  useEffect(() => {
    if (user) {
      const fetchFood = async () => {
        setLoading(true);
        try {
          const endpoint = `http://localhost:5005/api/foodItems?category=${category}&page=${page}&sort=${sort}&order=${order}&search=${search}`;
...
//   const categories = ["all", "starter", "main", "dessert", "beverage", "appetizer", "special"];
...
//       <h2 className="text-xl text-[#FFD93D] mb-4">Explore Our Menu</h2>
